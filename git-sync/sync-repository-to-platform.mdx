...
<Info>
You can connect both **public** and **private** repositories to Osmosis. For private repositories, you'll need to grant Osmosis access through GitHub OAuth or a deploy key. For detailed setup instructions, see the [GitHub Integration](/platform/github-integration) guide.
</Info>
