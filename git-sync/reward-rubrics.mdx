...
<Note>
For additional providers (Google Gemini, xAI Grok, OpenRouter, Cerebras), see the [API Reference](/python-sdk/api-reference#supported-providers).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="python" href="/python-sdk/api-reference">
    Full API reference
  </Card>
